...
# under the License.
#
# python-subjectclient documentation build configuration file, created by
...
htmlhelp_basename = 'python-subjectclientdoc'
...
# .
latex_documents = [
    ('index', 'python-subjectclient.tex', 'python-subjectclient Documentation',
