...
.. seealso::
    ...
    __ http://docs.openstack.org/api/openstack-subject/2/content/
...
.. _git.openstack.org: https://git.openstack.org/cgit/openstack/python-subjectclient
.. _Launchpad: https://launchpad.net/subject
...
The process for command deprecation is:
  ...
  2. Once the change is approved, have a member of the `subject-release`_ team
     release a new version of python-subjectclient.

     .. _subject-release: https://review.openstack.org/#/admin/groups/147,members
